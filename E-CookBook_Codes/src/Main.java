...
import java.util.Queue;
    ...
    public class Main {
        public static void main(String[] args) {
            ...
            //Kategorileri array halinde yazıyoruz
            String[] soups = {"Lentil Soup", "Yoghurt Soup", "Ezogelin Soup", "Tarhana Soup", "Broccoli Soup"};
            String[] meatDishes = {"Sauteed Meat", "Patlıcan Oturtma", "White Bean Stew With Meat", "Mantı", "Karnıyarık"};
            String[] oliveOilDishes = {"Yaprak Sarma", "Artichoke With Olive Oil", "Zucchini Stew", "Cauliflower With Olive Oil", "Spinach With Olive Oil"};
            String[] vegetarianDishes = {"Patatas Bravas", "Ratatouille", "Mücver", "Falafel", "Celery With Orange Sauce"};
            String[] deserts = {"Chocolate Chip Cookies", "Sütlaç", "San Sebastian Cheesecake ", "Magnolia", "Halva"};
            ...
            System.out.println("----------");
            System.out.println("Yoğurt Çorbası Malzemeleri");
            yoghurtSoupTree.printIngredients();
            System.out.println("----------");
            System.out.println("Çikolatalı Kurabiye Malzemeleri");
            chocolateChipCookiesTree.printIngredients();


            // Karnıyarık tarifi yazdır
            System.out.println("----------");
            System.out.println("Halva Recipe:");
            PrintSteps.halvaSteps();
